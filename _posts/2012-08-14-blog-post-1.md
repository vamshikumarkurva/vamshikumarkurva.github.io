...
As you can see in the above image, there are clearly 3 clusters, and a single gaussian fir to the data won't be able to capture the structure in the data.
