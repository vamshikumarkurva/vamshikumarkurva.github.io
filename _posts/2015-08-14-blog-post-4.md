...
<p align="center">
  <img src="https://github.com/vamshikumarkurva/vamshikumarkurva.github.io/blob/master/_posts/Images/eigen_decomp_geometric.png?raw=true" alt="Photo" style="width: 450px;"/>
  <p align="center">
    <em>Geometric intuition of eigen decomposition as sequential linear transformations. Top-left to bottom-left: $$P^{-1}$$ performs a basis change, mapping the eigenvectors into the standard basis. Bottom-left to bottom-right: $$D$$ performs a scaling along the remapped orthogonal eigenvectors, depicted here by a circle being stretched to an ellipse. Bottom-right to top-right: $$P$$ undoes the basis change (depicted as a reverse rotation) and restores the original coordinate frame.</em>
  </p>
</p>
