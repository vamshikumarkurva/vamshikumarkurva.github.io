...
<p align="center">
  <img src="https://github.com/vamshikumarkurva/vamshikumarkurva.github.io/blob/master/_posts/Images/SVD_geometric.png?raw=true" alt="Photo" style="width: 450px;"/>
  <p align="center">
    <em>Geometric intuition of SVD of a matrix \begin{equation*}A \in \mathbb{R}^{3 \times 2}\end{equation*} as sequential linear transformations. Top-left to bottom-left: $$V^T$$ performs a basis change in $$\mathbb{R}^2$$. Bottom-left to bottom-right: $$S$$ scales and maps $$\mathbb{R}^2$$ to $$\mathbb{R}^3$$, the ellipse in the bottom right lies in $$\mathbb{R}^3$$. Bottom-right to top-right: $$U$$ performs basis change in $$\mathbb{R}^3$$</em>
  </p>
</p>
